...
exports.shows = function(req,res) {
    var transaction_id = req.params.transaction_id;
    sequelize.query('SELECT transactionId,offer,qty,listingId FROM ServicesTransactions WHERE transactionId = ' + transaction_id,{model:servicesTransactions}).then((Transactions)=>{
        ...
        const create_payment_json = {
            ...
            "redirect_urls": {
                "return_url": "http://localhost:3000/successs/" + transaction_id, 
                "cancel_url": "http://localhost:3000/transactions"
            },
            "transactions": [{
                "item_list": {
